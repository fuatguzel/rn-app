...
import HandWashingScreen from './HandWashingScreen';
import VaccineScreen from './VaccineScreen';
import SocialDistanceScreen from './SocialDistanceScreen';
          ...
          <View>
            ...
            <View style={styles.infoContainer}>
              <View style={styles.infoBoxText}>
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate('MaskScreen');
                  }}
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('HandWashingScreen');
                }}
              ...
              <View style={styles.infoBox}>
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate('SocialDistanceScreen');
                  }}
              ...
              <View style={styles.infoBox}>
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate('VaccineScreen');
                  }}
